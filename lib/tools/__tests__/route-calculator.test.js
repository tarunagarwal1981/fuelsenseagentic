...
exports.testSingaporeToRotterdam = testSingaporeToRotterdam;
exports.testTokyoToShanghai = testTokyoToShanghai;
exports.testBarcelonaToHamburg = testBarcelonaToHamburg;
exports.testInvalidPortCodes = testInvalidPortCodes;
exports.testDifferentVesselSpeeds = testDifferentVesselSpeeds;
exports.runAllTests = runAllTests;
const route_calculator_1 = require("../route-calculator");
/**
 * Formats test results for readable output
 */
function formatTestResult(testName, result, error) {
    console.log('\n' + '='.repeat(80));
    ...
    if (error) {
        ...
        if (error instanceof route_calculator_1.RouteCalculationError) {
 ...
 */
async function testSingaporeToRotterdam() {
    const testName = 'Singapore to Rotterdam (Suez Canal Route)';
    try {
        const result = await (0, route_calculator_1.calculateRoute)({
        ...
        formatTestResult(testName, null, error);
    }
}
/**
 ...
 */
async function testTokyoToShanghai() {
 ...
 */
async function testBarcelonaToHamburg() {
 ...
 */
async function testInvalidPortCodes() {
    const testCases = [
        {
    ...
    for (const testCase of testCases) {
        ...
        console.log('-'.repeat(80));
        try {
            const result = await (0, route_calculator_1.calculateRoute)(testCase.input);
 ...
 */
async function testDifferentVesselSpeeds() {
    const testName = 'Different Vessel Speeds';
    try {
        const slowResult = await (0, route_calculator_1.calculateRoute)({
            origin_port_code: 'SGSIN',
            destination_port_code: 'HKHKG',
            vessel_speed_knots: 10,
        });
        const fastResult = await (0, route_calculator_1.calculateRoute)({
            origin_port_code: 'SGSIN',
            destination_port_code: 'HKHKG',
...
//# sourceMappingURL=route-calculator.test.js.map