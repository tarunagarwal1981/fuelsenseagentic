...
const complete_bunker_agent_1 = require("../complete-bunker-agent");
async function testCompleteAgent() {
    ...
    try {
        ...
        console.log('\n');
        const result1 = await (0, complete_bunker_agent_1.runCompleteBunkerAgent)(`I need to bunker 1000 MT of VLSFO on my voyage from Singapore to Rotterdam. 
       ...
       Find the most economical bunker port considering both fuel price and deviation costs.`, {
        ...
        console.log('\n');
        const result2 = await (0, complete_bunker_agent_1.askCompleteBunkerAgent)(`What's the cheapest bunker option from Tokyo to Shanghai for 1500 MT of VLSFO? 
...
testCompleteAgent();
//# sourceMappingURL=complete-bunker-agent.test.js.map